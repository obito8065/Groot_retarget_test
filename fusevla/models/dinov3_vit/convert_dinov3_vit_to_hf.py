...
from dinov3_vit.modeling_dinov3_vit import DINOv3ViTConfig, DINOv3ViTModel
from dinov3_vit.image_processing_dinov3_vit_fast import DINOv3ViTImageProcessorFast
