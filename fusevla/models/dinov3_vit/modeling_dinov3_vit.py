...
class DINOv3ViTEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor, bool_masked_pos: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        patch_embeddings = self.patch_embeddings(pixel_values.to(dtype=target_dtype)) # [B,3,224,224]->[B,1024,14,14]
        patch_embeddings = patch_embeddings.flatten(2).transpose(1, 2) # 14*14=196
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if return_hidden_states_index == i:
...
# register
AutoConfig.register("dinov3_vit", DINOv3ViTConfig)
AutoModel.register(DINOv3ViTConfig, DINOv3ViTModel)