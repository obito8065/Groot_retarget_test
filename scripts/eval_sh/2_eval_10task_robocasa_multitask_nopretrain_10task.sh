...
python3 scripts/batch_robocasa_eval.py \
    ...
    --n_envs 10 \
    --n_episodes 100 \
    --base_video_dir /mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_video_record/output_robocasa_10tasks_sample/n1.5_nopretrain_finetune_on_robocasa_v0.1/24k