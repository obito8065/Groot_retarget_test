...
python3 scripts/batch_robocasa_eval.py \
    --model_path /mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_ckpt/output_robocasa_ckpt_24tasks_sample/n1.5_pretrainALL6k_finetuneALL_on_robocasa_eepose_v0.1/checkpoint-12000 \
    ...
    --n_episodes 100 \
    --use_eepose \
    --base_video_dir /mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_video_record/output_robocasa_24tasks_sample/n1.5_pretrainALL_finetuneALL_robocasa_ee_v0.1/12k