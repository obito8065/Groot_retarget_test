#!/bin/bash
# 测评GR00t-n15的resume gr1 Actionhead for robocasa:
...
python3 scripts/batch_robocasa_eval.py \
    --model_path /mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_ckpt/output_robocasa_ckpt_24tasks/n1.5_nopretrain_finetune_on_robocasa_v0.0/checkpoint-12000 \
    --embodiment_tag gr1 \
    ...
    --n_episodes 100 \
    --use_eepose \
    --base_video_dir /mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_video_record/output_robocasa_24tasks/n1.5_nopretrain_finetune_on_robocasa_v0.0/12k