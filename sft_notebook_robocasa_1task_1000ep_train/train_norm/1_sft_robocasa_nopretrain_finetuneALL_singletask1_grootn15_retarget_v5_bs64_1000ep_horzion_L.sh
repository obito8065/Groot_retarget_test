...
dataset_list=(
      "/vla/users/lijiayi/robocasa_datasets_full/pick_and_place_lerobot_task24/gr1_unified.PnPWineToCabinetClose_GR1ArmsAndWaistFourierHands_1000_keypoints_v5"
)
data_config=(
...
OUTPUT_DIR=/vla/users/lijiayi/code/groot_retarget/output_ckpt/n1.5_nopretrain_finetuneALL_on_robocasa_taskL_retarget_v5_bs384_horizon50_1000ep
