...
OUTPUT_DIR=/mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_ckpt/output_robocasa_ckpt_1tasks_1000ep/n1.5_pretrainVL_finetuneALL_on_robocasa_task1_v0.1
