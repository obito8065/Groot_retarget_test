...
python3 scripts/simulation_service.py \
        ...
        --port 57309 \
        --host localhost \
        --video_dir /vla/users/lijiayi/unifytip_groot/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_retarget_v5_bs384_horizon50_taskR/37ksteps-batch3 \
         --n_episodes 100 \
        --n_envs 1 \
