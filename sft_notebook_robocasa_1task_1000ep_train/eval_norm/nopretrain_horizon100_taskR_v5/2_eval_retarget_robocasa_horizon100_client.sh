...
python3 scripts/simulation_service.py \
        ...
        --port 57201 \
        --host localhost \
        --video_dir /vla/users/lijiayi/code/groot_retarget/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_taskR_retarget_v5_bs384_horizon100/39ksteps-modify0 \
        --n_episodes 1 \
        --n_envs 1 \
