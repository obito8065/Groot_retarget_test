...
python3 scripts/inference_service.py --server \
    --model_path /vla/users/lijiayi/unifytip_groot/output_ckpt/n1.5_nopretrain_finetuneALL_on_robocasa_1000ep_taskL_retarget_v5_bs512_horizon50/checkpoint-90000 \
