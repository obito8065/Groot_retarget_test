...
python3 scripts/simulation_service.py \
        ...
        --port 57200 \
        --host localhost \
        --video_dir /vla/users/lijiayi/code/groot_retarget/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_task1_retarget_v4_bs384_horizon50_task1/33ksteps-modify0 \
        --n_episodes 1 \
        --n_envs 1 \
