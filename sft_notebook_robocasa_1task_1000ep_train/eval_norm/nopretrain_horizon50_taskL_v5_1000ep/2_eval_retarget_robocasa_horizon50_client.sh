...
python3 scripts/simulation_service.py \
        ...
        --port 51200 \
        --host localhost \
        --video_dir /vla/users/lijiayi/unifytip_groot/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_retarget_v5_1000ep_bs512_horizon50_taskL/90ksteps-modify6-seed4 \
        --n_episodes 1 \
        --n_envs 1 \
