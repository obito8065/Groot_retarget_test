...
python3 scripts/inference_service.py --server \
    --model_path /vla/users/lijiayi/code/groot_retarget/output_ckpt/n1.5_nopretrain_finetuneALL_on_robocasa_taskL_retarget_v5_bs384_horizon50_1000ep/checkpoint-44000 \
