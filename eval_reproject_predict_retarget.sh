...
python eval_predict_reprojector_cli.py \
    --video /vla/users/lijiayi/unifytip_groot/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_task2_retarget_v5_bs384_horizon50_taskR/33ksteps-modify6/33-6-false.mp4 \
    --keypoints /vla/users/lijiayi/unifytip_groot/output_video_record/predicted_keypoints_20260227_151255.txt \
    --fps 30 \
    --steps-per-chunk 50 \
    --radius 8
...
python eval_after_retarget_reprojector_cli.py \
    --video   /vla/users/lijiayi/unifytip_groot/output_video_record/output_retarget_1tasks_1000ep/n1.5_nopretrain_finetuneALL_on_robocasa_task2_retarget_v5_bs384_horizon50_taskR/33ksteps-modify6/33-6-false_reprojected.mp4 \
    --retarget /vla/users/lijiayi/unifytip_groot/output_video_record/retargeted_actions_20260227_151256.txt \
    --fps 30 \
    --steps-per-chunk 50 \
    --axis-length 0.05
