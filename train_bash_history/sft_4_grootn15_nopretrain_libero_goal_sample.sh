...
dataset_list=(
    # "/vla/users/zhaolin/datasets/libero/sample_lerobot_libero/libero_goal_no_noops_sample/"
    "/vla/users/zhaolin/datasets/libero/lerobot_libero/libero_goal_sampled"
)
data_config=(
  "libero_image_wrist"
)
...
OUTPUT_DIR=/vla/users/lijiayi/code/GR00T_QwenVLA/outputs/libero_goal/n1.5_nopretrain_finetune_on_sample_libero_goal_v2.1
