...
OUTPUT_DIR=../outputs/timeactionhead_tune_vit_libero_qwenvla_usepretrain_oxeall_190000_tag_5w
...
MODELPATH=../outputs/pretrain_qwen_oxe_all_v1.5_tune_vit_timeactionhead/checkpoint-190000
