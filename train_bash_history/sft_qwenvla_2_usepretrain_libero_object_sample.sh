...
export DEFAULT_EAGLE_PATH=/vla/users/lijiayi/code/GR00T_QwenVLA/gr00t/checkpoint/Qwen2.5-VL-3B-Instruct
dataset_list=(
...
OUTPUT_DIR=/vla/users/lijiayi/code/GR00T_QwenVLA/outputs_qwen/libero_object/n1.5_pretrain_finetune_on_sample_object_v2.1
...
MODELPATH=/vla/users/lijiayi/code/GR00T_QwenVLA/gr00t/checkpoint/pretrain_v1.6_qwenvla_tune_vit_timeactionhead-checkpoint-60000
...
--backbone_model_name_or_path /vla/users/lijiayi/code/GR00T_QwenVLA/gr00t/checkpoint/Qwen2.5-VL-3B-Instruct \
--tune_visual \
