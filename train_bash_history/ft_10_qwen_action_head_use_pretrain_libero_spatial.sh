...
dataset_list=(
    ...
    "/vla/users/zhaolin/datasets/libero/lerobot_libero/libero_spatial_no_noops"
)
data_config=(
  "libero_image_wrist"
)
...
OUTPUT_DIR=../outputs/timeactionhead_tune_vit_libero_qwenvla_usepretrain_oxeall_190000_tag_5w_spatial
