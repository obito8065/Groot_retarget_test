...
echo "TimeAwareActionHead: change layers and heads"
OUTPUT_DIR=../outputs/Qwen_ft_on_libero_tune_visual_timeactionhead_12layers_5w
...
--action_dim 1536 --action_heads 32 --action_layers 12
