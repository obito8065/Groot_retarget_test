...
dataset_list=(
    /mnt/workspace/datasets/egodex30w_datasets/egodex_merge30w_Agibot
)
data_config=(
...
OUTPUT_DIR=/mnt/workspace/users/lijiayi/GR00T_QwenVLA/output_ckpt/n1.5_pretrain_egodex_Agibot_tuneALL_v1.0
